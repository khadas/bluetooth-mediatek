...
ifeq ($(BT_DRIVER_WOBLE_ENABLE), true)
	$(MAKE) -C $(KERNEL_OUT) MTK_CHIP_PCM=TRUE MTK_WOBLE_ENABLE=TRUE M=$(PRIVATE_DRIVER_LOCAL_DIR) ARCH=$(TARGET_KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) modules
	$(MAKE) -C $(KERNEL_OUT) MTK_CHIP_PCM=TRUE MTK_WOBLE_ENABLE=TRUE M=$(PRIVATE_DRIVER_LOCAL_DIR) ARCH=$(TARGET_KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) modules INSTALL_MOD_PATH=$(PRODUCT_OUT)/obj/KERNEL_OBJ modules_install
else
...
ifeq ($(BT_DRIVER_WOBLE_ENABLE), true)
	$(MAKE) -C $(KERNEL_OUT) MTK_WOBLE_ENABLE=TRUE M=$(PRIVATE_DRIVER_LOCAL_DIR) ARCH=$(TARGET_KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) modules
	$(MAKE) -C $(KERNEL_OUT) MTK_WOBLE_ENABLE=TRUE M=$(PRIVATE_DRIVER_LOCAL_DIR) ARCH=$(TARGET_KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) modules INSTALL_MOD_PATH=$(PRODUCT_OUT)/obj/KERNEL_OBJ modules_install
else
